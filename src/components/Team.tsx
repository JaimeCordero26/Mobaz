const TEAM = [
  ...
  { name: "Bryan Mora Cordero", role: "Propietario y Desarrollador", profession: "Ingeniero Electromecánico (IME-28435)", photo: "/team/bryan.png" },
  { name: "Alfonso Castro", role: "Director de Proyecto", profession: "Arquitecto (ARQ-37779)", photo: "/team/alfonso.png" },
  { name: "Tatiana Fonseca Fernández", role: "Directora de Proyecto", profession: "Arquitecta (ARQ-29725)", photo: "/team/tatiana.png" },
  { name: "Douglas Melgara", role: "Director de Proyecto", profession: "Ingeniero Civil", photo: "/team/douglas.png" },
];
